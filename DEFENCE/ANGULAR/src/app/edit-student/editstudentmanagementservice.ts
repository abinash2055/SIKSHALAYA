...
export class EditStudentManagementService {

  constructor(private http: HttpClient) { }

  editStudent(studentId: string, fullName: string, email: string, 
    phoneNumber: string, gender: string, dateOfBirth: Date): Observable<any> {
    const body = {
      studentId: studentId,
      fullName: fullName,
      email: email,
